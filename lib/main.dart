...
class _placesListState extends State<placesList> {
  ...
  void openEdit(dynamic places) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => EditplacesPage(places: places)),
    ...
    return Scaffold(
            ...
            child: filteredplaces.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      String imageUrl = "${baseUrl}images/${places['image']}";
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => placesDetail(places: places),
                              ),
                            );
                          },
                        ),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const AddplacesPage()),
          ).then((value) => fetchplaces());
        },
      ),
    );
...
class placesDetail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(places['name'] ?? 'Detail')),
      body: Padding(
