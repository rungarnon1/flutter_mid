...
const String baseUrl = "http://127.0.0.1/flutter_66709687_mid/php_api/";
...
class _EditplacesPageState extends State<EditplacesPage> {
  ...
  void initState() {
    ...
    nameController = TextEditingController(text: widget.places['name']);

    addressController = TextEditingController(text: widget.places['address']);

    provinceController = TextEditingController(text: widget.places['province']);

    descriptionController = TextEditingController(text: widget.places['description']);
  }
  ...
  Future<void> updateplaces() async {
    try {
      ...
      request.fields['image'] = widget.places['image'];
  ...
  Widget build(BuildContext context) {
    String imageUrl = "${baseUrl}images/${widget.places['image']}";
